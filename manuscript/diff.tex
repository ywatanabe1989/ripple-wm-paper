...
%DIF ADD ./manuscript.tex                         Sat Aug 17 16:17:53 2024
...
\DIFdelbegin %DIFDELCMD < \author[2,3,4]{%%%
\DIFdel{Yuji Ikegaya}\DIFdelend %DIF >  \author[2,3,4]{Yuji Ikegaya}
\DIFaddbegin \author[1,3]{\DIFadd{Takufumi Yanagisawa}\DIFaddend }
\DIFdelbegin %DIFDELCMD < \author[1,5]{Takufumi Yanagisawa}
%DIFDELCMD < %%%
\DIFdelend 

\address[1]{Institute for Advanced Cocreation studies, Osaka University, 2-2 Yamadaoka, Suita, 565-0871, Osaka, Japan}
\DIFdelbegin %DIFDELCMD < \address[2]{Graduate School of Pharmaceutical Sciences, The University of Tokyo, 7-3-1 Hongo, Tokyo, 113-0033, Japan}
%DIFDELCMD < \address[3]{Institute for AI and Beyond, The University of Tokyo, 7-3-1 Hongo, Tokyo, 113-0033, Japan}
%DIFDELCMD < \address[4]{Center for Information and Neural Networks, National Institute of Information and Communications Technology, 1-4 Yamadaoka, Suita City, 565-0871, Osaka, Japan}
%DIFDELCMD < \address[5]{Department of Neurosurgery, Osaka University Graduate School of Medicine, 2-2 Yamadaoka, Osaka, 565-0871, Japan}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \address[2]{Department of Biomedical Engineering, The University of Melbourne, Melbourne, Victoria, 3010, Australia}
%DIF >  \address[2]{Graduate School of Pharmaceutical Sciences, The University of Tokyo, 7-3-1 Hongo, Tokyo, 113-0033, Japan}
%DIF >  \address[3]{Institute for AI and Beyond, The University of Tokyo, 7-3-1 Hongo, Tokyo, 113-0033, Japan}
%DIF >  \address[4]{Center for Information and Neural Networks, National Institute of Information and Communications Technology, 1-4 Yamadaoka, Suita City, 565-0871, Osaka, Japan}
...
\DIFadd{States of phases were defined as the NT during phases:
}
...
\DIFadd{where $S_F$ is the state of fixation, $S_E$ is encoding, $S_M$ is maintenance, and $S_R$ is retrieval; $N_{i}$ is the $i^{th}$ NT coordinate, calculated from 50-ms unit activity data.
}

\subsection{\DIFadd{Geometric Medians of States}}
\DIFadd{From the middle 1 second (= 20 x 50-ms bins) of each state, the geometric median was calculated:
}
...
\DIFadd{It is noteworthy that geometric median is calculated by minimizing the sum of distances to the sample points:
%DIF > % the geometric median of $x_1, \dots, x_n \in \mathbb{R}^d$ is defined as
}\begin{equation}
