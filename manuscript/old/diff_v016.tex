...
%DIF ADD ./manuscript.tex                           Sun May  5 08:03:32 2024
...
\\
\indent
Current evidence suggests that a transient, synchronized oscillation, called sharp-wave ripples (SWRs) \cite{buzsaki_hippocampal_2015}, is associated with \DIFdelbegin \DIFdel{several cognitive functions. These include memory replay \mbox{%DIFAUXCMD
...
}\DIFdelend \DIFaddbegin \DIFadd{various cognitive functions, including WM performance \mbox{%DIFAUXCMD
\cite{jadhav_awake_2012, sasaki_dentate_2018}}\hspace{0pt}%DIFAUXCMD
. Although SWRs are traditionally linked with long-term memory functions such as memory replay \mbox{%DIFAUXCMD
...
, their role in WM tasks remains underexplored. This gap in understanding motivates the current study to investigate the potential involvement of SWRs in WM, particularly given their }\DIFaddend fundamental computational manifestation \DIFdelbegin \DIFdel{of hippocampal processing, contributing to working memory performance as well}\DIFdelend \DIFaddbegin \DIFadd{in hippocampal processing}\DIFaddend .
\\
\indent
