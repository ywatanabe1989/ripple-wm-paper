...
%DIF ADD ./manuscript.tex                           Sun May  5 13:16:30 2024
...
\cite{yu_gaussian-process_2009, ecker_state_2014, kim_corticalhippocampal_2023, gallego_neural_2017, wei_orderly_2019, churchland_neural_2012, churchland_stimulus_2010, kao_single-trial_2015, lin_functional_2011}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .
...
Our analysis focused on putative CA1 regions (Figure~\ref{fig:04}), is supported by several factors. This specific focus results from established observations that SWRs synchronize with interneuron and pyramidal neuron spike bursts \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
