...
\subsection{Calculation of NT using GPFA and Definitions of States}
...
\\
\indent
For each NT within a region such as AHL, the geometric median of each phase was calculated ($\mathrm{g_{F}}$ for fixation, $\mathrm{g_{E}}$ for encoding, $\mathrm{g_{M}}$ for maintenance, and $\mathrm{g_{R}}$ for retrieval phase). In this paper, these geometric medians will also be referred to as "states".
\\
\indent
